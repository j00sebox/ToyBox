...
public:
	...
	static void draw_elements(const Transform& transform, const MeshView&, const Material&);
    static void draw_elements_instanced(unsigned int instances, const MeshView&, const Material&);
    static void draw_skybox(const Skybox& skybox);
	static void stencil(const Transform& stencil_transform, const MeshView&, const Material&);
